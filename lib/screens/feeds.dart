...
class FeedsScreen extends StatelessWidget {
  FeedsScreen({Key? key, argument}) : super(key: key);
                    ...
                    child: Padding(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                            model.length,
                            (index) =>
                                productItem(context, model[index], index)),
                      ),
                    ),
                  ),
                  SizedBox(
                    ...
                    child: IconButton(
                        ...
                        onPressed: () {
                          HomeCubit.get(context)
                              .deleteProduct(context,productId: model.docId);
                          print(model.id);
                        },
                        icon: Icon(
                          Icons.close,
